...
<head>
	...
	<script>
...

		{
			...
			window.location.href = 'stockReg_ost.php';
		...
		async function getexcel() {
			...
			let pageSize = document.getElementById('itemsPerPageDropdown').value;
			try {
				const response = await fetch(`http://localhost:8080/download/outOfStock/stockRegister/${companyId}/${productTypeId}/${locationId}/${productCategoryId}/${brandName}/${search}/${currentPage-1}/${pageSize}`, {
					method: 'GET',
					headers: {
						'Authorization': token,
					},
...

		{
			...
			var scriptUrl = 'mpdf/print_files/stockReg_ost_pdf.php?compId=' + compId + '&iType=' + iType + '&locId=' + locId + '&uId=' + uId + '&uiType=' + uType + '&role=' + uRole + '&srch=' + srch + '&catId=' + catId + '&brand=' + brand;
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="align-items-center justify-content-between mb-2" style="background-color:#3c8dbc;border-radius:5px;" align="center">
						...
						<h1 class="h3 mb-0 text-gray-801" style="padding-bottom: 5px;">Out Of Stock Report</h1>
										...
										<table cellpadding="5px">
											...
											<tr>
												...
												<td valign="top">
													...
													<select class="form-control form-control-sm" id="compId" name="compId" tabindex="1" style="width:250px;" onChange="getMainData(); getLocationData();">
											...
											<tr>
												...
												<td valign="top">
													...
													<select class="form-control form-control-sm" id="brand" name="brand" tabindex="5" onChange="getMainData();" style="width:250px;" onChange="getMainData();" required>
											...
											<tr>
												...
												<td valign="top">
													...
													<label class="m-0 font-weight-bold text-primary">Search</label>
