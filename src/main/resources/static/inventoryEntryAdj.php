...
<select class="chosen-select form-control form-control-sm" id="location" name="location" tabindex="3" onChange="getDocNo();" style="width:250px;">
...
if($uRole=='admin' || $userId=='13' || $userId=='12')

{

 $mindt=date('Y-m-d',(strtotime ( '-30 day' , strtotime ( $dt) ) ));	
 //$mindt=date('Y-m-d',(strtotime ( '-2 day' , strtotime ( $dt) ) ));	
...
<select class="chosen-select form-control form-control-sm" id="eType" name="eType" tabindex="5" onChange="geteType()" style="width:250px;">
...
<select class="chosen-select form-control form-control-sm" id="itemId" name="itemId" tabindex="7.1" onChange="getProductInfo();" style="width:250px;">
...
<select class="chosen-select form-control form-control-sm" id="bctNo" name="bctNo" tabindex="7.2" style="width:250px;">
...

    {
      ...
      $.ajax({
...

           {
			   ...
			   window.location.href='inventoryEntryAdj.php';
