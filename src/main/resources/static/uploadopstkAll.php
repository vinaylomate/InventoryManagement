      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h4 mb-0 text-gray-800" style="height:0px;padding-bottom: 10px;">Update Open Stock</h1>     
          </div>
...
<div class="col-lg-12">
<div class="p-2"> 
<form class="user" action="uploadopstkAll_ins.php" method="post" enctype="multipart/form-data"> 
