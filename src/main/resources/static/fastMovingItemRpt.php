...
<head>
	...
	<script>
		...
		function getMainData() {
			...
			var url = `http://localhost:8080/manage/get/fastMovingReport/${companyId}/${productTypeId}/${locationId}/${search}/${currentPage-1}/${pageSize}/${fromDate}/${endDate}/`;
			$.ajax({
