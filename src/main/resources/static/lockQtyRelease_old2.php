...
<td valign="top">:</td>	
<td valign="top">
<select class="chosen-select form-control form-control-sm" id="eTypeR" name="eTypeR" tabindex="1" onChange="geteType();getDocNo();">
<option value="0">Select</option>
<?php
include("mysql.connect.php");
...
<td valign="top">:</td>	
<td valign="top">
<input type="text" class="form-control form-control-sm" id="refR" name="refR" value="" placeholder="Reference" tabindex="3">
</td>
...
<td valign="top">:</td>	
<td valign="top">
<input type="text" class="form-control form-control-sm" id="ntsR" name="ntsR" value="" placeholder="Reference" tabindex="3.1">
</td>		
