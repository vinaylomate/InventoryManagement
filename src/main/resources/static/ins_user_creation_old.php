...
$qq="SELECT UserNm FROM admin_tbl WHERE UserNm='$name' AND compId='$compId' AND sts='0' AND iType='$iType'";
$st=$mysql->prepare($qq);
$st->execute();
...
{
	$qry="INSERT INTO admin_tbl(UserNm,pwd,role,u_access,sub_access,act_edit,act_delete,compId,iType,act_create,act_view)
	VALUES('$name','$password','User','$access','$subaccess','$actEdit','$actDelete','$compId','$iType','$actCreate','$actView')";
	//echo $qry."<br>";
