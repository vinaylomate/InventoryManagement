  ...
  <script>
        ...
        success: function(data) {
          ...
          data.data.forEach((data) => {
            let row = `<tr style="text-align: center">
              ...
              <td>${data.notes}</td>
              <td>
              <a href = "getinventoryview.php?ID=${data.docNo.docNo}">
                <i class = "fa fa-eye">
                </i>
              </a>
              </td>
...

    {
      ...
      $.ajax({
        ...
        url: 'getinventoryReg.php',

        data: 'page=' + page_num + '&keywords=' + keywords + '&filterBy=' + filterBy + '&compId=' + compId + '&locId=' + locId + '&iType=' + iType + '&uId=' + uId + '&uloc=' + uloc + '&uiType=' + uiType
      ...
      /*var scriptUrl='getinventoryReg.php?compId='+compId+'&iType='+iType+'&locId='+locId+'&uId='+uId+'&fdt='+fdt+'&tdt='+tdt+'&uiType='+uType+'&role='+uRole+'&uloc='+uloc+'&srch='+srch;
...

    {
      ...
      var scriptUrl = 'inventoryRegEx.php?compId=' + compId + '&iType=' + iType + '&locId=' + locId + '&uId=' + uId + '&fdt=' + fdt + '&tdt=' + tdt + '&uiType=' + uType + '&role=' + uRole + '&uloc=' + uloc + '&srch=' + srch;
...

    {
      ...
      var scriptUrl = 'mpdf/print_files/Invn_pdf.php?compId=' + compId + '&iType=' + iType + '&locId=' + locId + '&uId=' + uId + '&fdt=' + fdt + '&tdt=' + tdt + '&uiType=' + uType + '&role=' + uRole + '&uloc=' + uloc + '&srch=' + srch;
...

    {
...

      {
        ...
        var scriptUrl = 'deleteInventory.php?ID=' + id + '&uid=' + uid;
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="align-items-center justify-content-between mb-2" style="background-color:#3c8dbc;border-radius:5px;" align="center">
            ...
            <h1 class="h3 mb-0 text-gray-801" style="padding-bottom: 5px;">Stock Entry Register</h1>
