                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  <thead>
                    <tr style="background-color:#b02923">
					  ...
					  <?php
					  $ql="SELECT ID,loc_code,location_name FROM location_tbl WHERE sts!='2' AND iType='1' ORDER BY loc_code";	
				  ...
				  while($row=$stm->fetch(PDO::FETCH_ASSOC))
				  {
					  ...
					  for($i=0;$i<$lcount;$i++)					  
					  {
						  ...
						  /*$qqq="SELECT a.itemId,a.locId,r.focus_code,r.sage_code,r.description,ru.uom,SUM(a.stk_qty) AS stk FROM stock_tbl AS a LEFT JOIN company_tbl AS c ON a.compId=c.ID LEFT JOIN location_tbl AS l ON a.locId=l.ID LEFT JOIN rm_master AS r ON a.itemId=r.rmId LEFT JOIN uom_tbl AS ru ON r.UOM=ru.ID WHERE a.sts!='2' AND r.sts!='2' AND  a.iType='1' AND a.itemId='$itemId' AND l.ID='$locId' GROUP BY a.itemId,r.focus_code,a.locId,r.sage_code,r.description,ru.uom ";*/
						  $qqq="SELECT r.focus_code,r.sage_code,r.description,ru.uom,SUM(a.stk_qty) AS stk FROM stock_tbl AS a LEFT JOIN rm_master AS r ON a.itemId=r.rmId LEFT JOIN uom_tbl AS ru ON r.UOM=ru.ID WHERE a.sts!='2' AND r.sts!='2' AND a.iType='1' AND r.focus_code='".$row['focus_code']."' AND r.sage_code='".$row['sage_code']."' GROUP BY r.focus_code,r.sage_code,r.description,ru.uom,a.locId";
