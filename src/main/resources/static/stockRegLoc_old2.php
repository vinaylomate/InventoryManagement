...
function getexcel()
{
	...
	var uRole=document.getElementById('urole').value;
 	...
 	var scriptUrl='stockRegLocEx.php?compId='+compId+'&iType='+iType+'&uId='+uId+'&uiType='+uType+'&role='+uRole+'&srch='+srch+'&catId='+catId;
	//alert(scriptUrl);
 	//dataTable
...
<td valign="top">:</td>	
<td valign="top"><input type="text" id="txtsearch" name="txtsearch" class="form-control" tabindex="4.1"></td>		

<td valign="top"><input type="button" id="btnsearch" name="btnsearch" class="btn btn-primary" onClick="getdata();" tabindex="4.2" value="Search"></td>	
<td valign="top"></td>	
<td valign="top"></td>	
