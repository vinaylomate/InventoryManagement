...
<div align="center" style="font-size:20px">RITVER <span style="font-size:14px;font-weight:bold;">PAINTS & COATINGS</span></div>
					<table width="100%"><tr>
					<td width="30%"></td>
					<td align="center"><u> '.strtoupper("Lock Qty Report").' </u></td>
...
<th style="color:#000">Salesman</th>
        ...
        {			  
            if($row['iType']=='1')
            {
               if($c==0)
               {
                ...
                $html=$html. '<td valign="top">'.$row['salemanNm'].'</td>';
...
$mpdf->SetTitle("Lock Quantity Register");
$mpdf->SetAuthor("");
