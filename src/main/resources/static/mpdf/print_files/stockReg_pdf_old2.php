...
<table width="100%"><tr>
<td width="30%"></td>
<td align="center"><u> '.strtoupper("Stock Report").' </u></td>
...
WHERE a.sts!='2' AND IF(a.iType='1',r.sts!='2',f.sts!='2') ".$str." ORDER BY a.ID";
		//echo "A : ".$qq."<br>";
	}
	else
	{
...
WHERE a.sts!='2' AND IF(a.iType='1',r.sts!='2',f.sts!='2') ".$str." AND u.uid='$uId' ORDER BY a.ID";
		//echo "B : ".$qq."<br>";
	}
}
else
...
LEFT JOIN category_master AS rg ON r.catId=rg.catId 
LEFT JOIN category_master AS fgg ON f.category_id=fgg.catId 
WHERE a.sts!='2' AND IF(a.iType='1',r.sts!='2',f.sts!='2') ORDER BY a.ID";
	}
	else
	{
		if($uRole=='admin' && ($uiType=='3' || $uiType=='0'))
...
<th style="color:#000;">Lock Qty</th>
<th style="color:#000;"><!--Closing-->Avail. Stock</th>
<th style="color:#000">Re - Order Level</th>
<th style="color:#000">Re - Order Req.</th>
<th style="color:#000">Rack No.</th>
</thead>
<tbody>"';
$a=$b=$c=$d=$e=0;	
...
<th style="color:#000">'.$b.'</th>
<th style="color:#000;">'.$c.'</th>
<th style="color:#000">'.$d.'</th>
<th style="color:#000;">'.$e.'</th>
<th style="color:#000;"></th>
<th style="color:#000"></th>
<th style="color:#000"></th>
<!--<th style="color:#000"></th>
...
$mpdf=new mPDF('c','A4-L','','',5,5,65,5,5,5);
