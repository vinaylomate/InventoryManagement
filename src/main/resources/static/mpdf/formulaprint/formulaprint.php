...
$html=$html.'<div style="margin-top:25px">
              <table class="gridtable" id="dataTable" width="100%" cellspacing="0">
                ...
                <th style="color:#000">RM Code</th>
                <th style="color:#000">Item</th>
                <th style="color:#000">Qty</th>
                <th style="color:#000">S.G</th>
                <th style="color:#000">Volume</th>
                <th style="color:#000">Rate</th>
                <th style="color:#000">Cost</th>
                <th style="color:#000">Stnd 100</th>
                </tr>';
				...
				{
					$html=$html. '<tr>';
					$html=$html. '<td style="color:#000">'.$cnt.'</td>';
					$html=$html. '<td style="color:#000">'.$rw['item'].'</td>';
					$html=$html. '<td style="color:#000">'.$rw['rm_code'].'</td>';
					$html=$html. '<td style="color:#000">'.$rw['qty'].'</td>';
					$html=$html. '<td style="color:#000">'.$rw['specific_gravity'].'</td>';
					$html=$html. '<td style="color:#000">'.$rw['volume'].'</td>';
					$html=$html. '<td style="color:#000">'.$rw['rate'].'</td>';
					$html=$html. '<td style="color:#000">'.$rw['cost'].'</td>';
					$html=$html. '<td style="color:#000">'.$rw['stand'].'</td>';
					$html=$html. '</tr>';
					$tot=$tot+$rw['qty'];
                ...
                <th style="color:#000">UOM</th>
                <th style="color:#000">Weight in KG</th>
                <th style="color:#000">Material Cost</th>
                <th style="color:#000">Drum Capacity</th>
                <th style="color:#000">Drum Cost</th>
                <th style="color:#000">Cost</th>
                <th style="color:#000">Overhead</th>
                <th style="color:#000">Sales Price</th>
                </tr>
                </thead>';
				...
				{
					$html=$html. '<tr>';
					$html=$html. '<td style="color:#000">'.$count.'</td>';
					$html=$html. '<td style="color:#000">'.$r['capacity'].'</td>';
					$html=$html. '<td style="color:#000">'.$r['UOM'].'</td>';
					$html=$html. '<td style="color:#000">'.$r['weight_kg'].'</td>';
					$html=$html. '<td style="color:#000">'.$r['material_cost'].'</td>';
					$html=$html. '<td style="color:#000">'.$r['drum_cap'].'</td>';
					$html=$html. '<td style="color:#000">'.$r['drum_cost'].'</td>';
					$html=$html. '<td style="color:#000">'.$r['cost'].'</td>';
					$html=$html. '<td style="color:#000">'.$r['overhead'].'</td>';
					$html=$html. '<td style="color:#000">'.$r['sale_price'].'</td>';
					$html=$html. '</tr>';
					$count++;
				}
				$mysql=null;
