			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="align-items-center justify-content-between mb-2" style="background-color:#3c8dbc;border-radius:5px;" align="center">
						...
						<h1 class="h3 mb-0 text-gray-801" style="padding-bottom: 5px;">Lock Qty Entry</h1>

					</div>

					<form class="user" action="#" method="POST" id="loqt" name="loqt" enctype="multipart/form-data">
											...
											<table cellpadding="5px">
												...
												<tr>
													...
													<td valign="top">
														...
														<select class="form-control form-control-sm" id="compId" name="compId" tabindex="1" required onChange="getLoc()" style="width:250px;">
													...
													<td valign="top">
														...
														<select class="form-control form-control-sm" id="iType" name="iType" tabindex="2" onChange="getLoc();getproduct();" style="width:250px;" required>
													...
													<td valign="top">
														...
														<select class="form-control form-control-sm" id="location" name="location" tabindex="3" onChange="getDocNo();getsalesman()" style="width:250px;">
												...
												<tr>
													...
													<td valign="top">
														...
														<select class="form-control form-control-sm" id="eType" name="eType" tabindex="5" onChange="geteType()" required>
...
<label class="m-0 font-weight-bold text-primary">Scan Barcode</label>-->
													...
													<td valign="top">
														...
														<div id="rmshow">
															...
															<div style="margin-bottom: 5px;">
																...
																<input type="text" class="form-control form-control-sm" id="txtsearch" name="txtsearch" placeholder="Search" tabindex="7.1" value="" onChange="getproduct()" required>

															</div>

															<select class="form-control form-control-sm" id="itemId" name="itemId" tabindex="7.2" onChange="getProductInfo();" style="width:250px;">
													...
													<td valign="top">
														...
														<div id="divbct" style="visibility: hidden;overflow: hidden;height: 0px;">
															...
															<select class="form-control form-control-sm" id="bctNo" name="bctNo" tabindex="7.3">
												...
												<tr>
													...
													<td valign="top"><label class="m-0 font-weight-bold text-primary" id="lbl1">Salesman</label></td>

													<td valign="top">:</td>

													<td valign="top">

														<select class="form-control form-control-sm" id="smId" name="smId" tabindex="7.4" required>
												...
												<tr>
													...
													<td valign="top"><label class="m-0 font-weight-bold text-primary" id="lbl1"></label></td>

													<td valign="top"></td>

													<td valign="top">

														<button type="button" id="btnAdd" name="btnAdd" class="btn btn-success" tabindex="8" onClick="getInfo('tbl_prod')">Add</button>
												...
												<div class="col-sm-12 mb-3 mb-sm-0 table-responsive">
													...
													<table width="100%" id="tbl_prod" class="table table-bordered">
														...
														<tr style="background-color:#b02923">
															...
															<th style="color:#fff;text-align:center">Lock Qty</th>
	...
	<script type="text/javascript">
...

		{
...

			{
				...
				var scriptUrl = 'getDocNos_lock.php?iType=' + id + '&compId=' + compId + '&locId=' + locId + '&yr=' + yr + '&yr2=' + yr2;
				...
				$.ajax({
...

					{
						...
						document.getElementById('txtserialno').value = result;
					...
					$.ajax({
...

						{
...

							{
								...
								if (id == pItemId[i].value && compId == pcompId[i].value && locId == plcId[i].value && eTypeId == peTypeId[i].value && batchdd[i].value == bctNo)
		...
		$("#btn").click(function()

			{
				...
				} else if ($("#smId").val().trim() == "0")

				{

					$("#smId").addClass("require");
				...
				} else if ($("#ref").val().trim() == "" || $("#ref").val().trim() == "0")
...

				{
					...
					$.ajax({
						...
						data: $("#loqt").serialize(), // serializes the form's elements.
...

						{
							...
							window.location.href = 'lockQty_entry.php';
...

		{
...

			{
				...
				var scriptUrl = 'getsalesmanNmN.php?compId=' + id + '&iType=' + iType + '&locId=' + locId + '&uId=' + uId;
				...
				$.ajax({
...

					{
						...
						$("#smId").html(result).trigger("chosen:updated.chosen");
