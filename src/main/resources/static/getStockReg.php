...
if(isset($_POST['page']))
{
 ...
 $whereSQL = ''; 
	...
	{
		$whereSQL=$whereSQL." AND c.ID='$compId' AND l.ID='$locId' ";
		//echo "AD-1".$str."<Br>";
	}					
	else 
	{
    ...
    if(!empty($_POST['keywords'])){ 
		...
		$whereSQL=$whereSQL." AND (CONCAT(l.loc_code,' - ',l.location_name) LIKE '%".$_POST['keywords']."%' OR IF(a.iType='1',r.focus_code,f.focus_code) LIKE '%".$_POST['keywords']."%' OR IF(a.iType='1',r.sage_code,f.sage_code) LIKE '%".$_POST['keywords']."%' OR IF(a.iType='1',CONCAT(r.description,' - ',ru.uom),CONCAT(f.descc,' - ',fu.uom)) LIKE '%".$_POST['keywords']."%' OR a.in_qty  LIKE '%".$_POST['keywords']."%' OR a.out_qty LIKE '%".$_POST['keywords']."%' OR a.lock_qty LIKE '%".$_POST['keywords']."%' OR a.stk_qty LIKE '%".$_POST['keywords']."%' OR IF(a.iType='1',r.reorder_level_qty,f.reorder_level_qty) LIKE '%".$_POST['keywords']."%' OR IF(a.iType='1',r.rackNo,f.rackNo) LIKE '%".$_POST['keywords']."%' )";
    } 
