...
<td valign="top">:</td>	
<td valign="top">
<select class="chosen-select form-control form-control-sm" id="location" name="location" tabindex="3" onChange="getproduct();getsalesman()" style="width:250px;">
<option value="0">Select</option>
</select>
</td>		
</tr>	
...
<select class="chosen-select form-control form-control-sm" id="bctNo" name="bctNo" tabindex="7.1">
<option value="0">Select</option>
</select>	
</div>	
</td>		
...
<td valign="top">:</td>	
<td valign="top">
<select class="chosen-select form-control form-control-sm" id="smId" name="smId" tabindex="7.2" required>
 <option value="0">Select</option>
</select>
</td>
...
function getsalesman()	
{
  ...
  else	
  {
	  ...
	  var uId= document.getElementById('uid').value;
	  var scriptUrl ='getsalesmanNm.php?compId='+id+'&iType='+iType+'&locId='+locId+'&uId='+uId;
	  //alert(scriptUrl);
      $.ajax({url:scriptUrl,success:function(result)
      {	
	  	 //alert(result);
