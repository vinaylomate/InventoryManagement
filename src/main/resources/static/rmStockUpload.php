			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="d-sm-flex align-items-center justify-content-between mb-4">
						...
						<h1 class="h4 mb-0 text-gray-800" style="height:0px;padding-bottom: 10px;">RM Stock Upload</h1>
							...
							<div class="row">
								...
								<div class="col-lg-12">
									...
									<div class="p-2">
										...
										<form class="user" action="rmStockUpload_ins.php" method="post" enctype="multipart/form-data">
											...
											<div class="form-group row">
												...
												<div class="col-sm-6 mb-3 mb-sm-0">
													...
													<a href="Excel/rmstk.csv"><label style="color:#F00;margin-top:10px"><b>Click Here For Sample CSV</b></label></a><br>
	...
	<script type="text/javascript">
...

		{
...

			{
				...
				var scriptUrl = 'getLocations.php?compId=' + id + '&iType=1';
