...
{	
	...
	$qq1="SELECT ID,docNo AS nos FROM doc_no_lk_tbl WHERE locId='$locId' AND yr='$yr2' ORDER BY docNo";
	...
	if($nosId==0)
	{
	  $qnos="INSERT INTO doc_no_lk_tbl(docNo,locId,yr)VALUES('$nos','$locId','$yr2')";	
	}
	else
	{
	  $qnos="UPDATE doc_no_lk_tbl SET docNo='$nos' WHERE locId='$locId' AND yr='$yr2' AND ID='$nosId'";		
	}
	...
	$qinv="INSERT INTO inventory_tbl(dt,compId,locId,iType,docNo,uid,yr,yr2,ref,notes,lsts,salemnId)
	VALUES('$dt','$compId','$locId','$iType','$docNo','$uId','$yr','$yr2','$ref','$notes','1','$salemanId')";
	//echo $qinv."<Br>";
