...
<select class="chosen-select form-control form-control-sm" id="itemId" name="itemId" tabindex="4.2" style="width:250px;">
...
<td valign="top"><label class="m-0 font-weight-bold text-primary">End Date</label></td>	

<td valign="top">:</td>	

<td valign="top">
<input type="date" class="form-control form-control-sm" id="txtdt2" name="txtdt2" value="<?php echo $dt?>" tabindex="4.4">
</td>	
<td>
<button type="button" id="btn" name="btn" class="btn btn-primary" tabindex="5" onClick="showOpClInfo();">Get Data</button>			
</td>
</tr>	
</table>
...
function getproduct()	
{
  ...
  else	
  {
        ...
        var scriptUrl ='getstkProducts.php?iType='+id+'&compId='+compId+'&locId='+locId;
...
function showOpClInfo()	
{
  ...
  else	
  {
        ...
        var fdt = document.getElementById('txtdt').value;

        var tdt = document.getElementById('txtdt2').value;
	  
        var scriptUrl ='getopenstkInfo_n.php?iType='+id+'&compId='+compId+'&locId='+locId+'&itemId='+itemId+'&fdt='+fdt+'&tdt='+tdt;
