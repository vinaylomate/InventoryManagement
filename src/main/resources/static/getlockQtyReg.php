...
{ 
    ...
    {
        $qq="SELECT a.ID,a.dt,a.compId,a.locId,a.iType,a.docNo,a.yr,a.yr2,b.company_code,b.company_name,c.loc_code,c.location_name,IF(a.iType='1','RAW MATERIAL','FINISHED GOODS') AS iTypeNm,ref,notes FROM inventory_tbl AS a LEFT JOIN company_tbl AS b ON a.compId=b.ID LEFT JOIN location_tbl AS c ON a.locId=c.ID WHERE a.sts!='2' AND b.sts!='2' AND c.sts!='2' AND a.lsts='1' ".$str." ORDER BY substring(a.docNo,1,9), substring(a.docNo,10)*1 DESC LIMIT $offset,$limit";

        $qqq="SELECT COUNT(a.ID) AS rowNum FROM inventory_tbl AS a LEFT JOIN company_tbl AS b ON a.compId=b.ID LEFT JOIN location_tbl AS c ON a.locId=c.ID WHERE a.sts!='2' AND b.sts!='2' AND c.sts!='2' AND a.lsts='1' ".$str." ORDER BY substring(a.docNo,1,9), substring(a.docNo,10)*1 DESC";
    ...
    {
        $qq="SELECT a.ID,a.dt,a.compId,a.locId,a.iType,a.docNo,a.yr,a.yr2,b.company_code,b.company_name,c.loc_code,c.location_name,IF(a.iType='1','RAW MATERIAL','FINISHED GOODS') AS iTypeNm,a.ref,a.notes FROM inventory_tbl AS a LEFT JOIN company_tbl AS b ON a.compId=b.ID LEFT JOIN location_tbl AS c ON a.locId=c.ID LEFT JOIN admin_usr_loc AS us ON c.ID=us.locId WHERE a.sts!='2' AND b.sts!='2' AND c.sts!='2' AND a.lsts='1' ".$str." AND us.uid='$uId' ORDER BY substring(a.docNo,1,9), substring(a.docNo,10)*1 DESC LIMIT $offset,$limit";

        $qqq="SELECT COUNT(a.ID) AS rowNum FROM inventory_tbl AS a LEFT JOIN company_tbl AS b ON a.compId=b.ID LEFT JOIN location_tbl AS c ON a.locId=c.ID LEFT JOIN admin_usr_loc AS us ON c.ID=us.locId WHERE a.sts!='2' AND b.sts!='2' AND c.sts!='2' AND a.lsts='1' ".$str." AND us.uid='$uId' ORDER BY substring(a.docNo,1,9), substring(a.docNo,10)*1 DESC";
		$query1=$mysql->prepare($qqq);
        $query1->execute();
        $result  = $query1->fetch(PDO::FETCH_ASSOC); 
        $rowCount= $result['rowNum'];
